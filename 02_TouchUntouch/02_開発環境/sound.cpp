...
{
	{ "data/BGM/tut_bgm_out.wav",	0.5f, -1},	// アウトゲームBGM
	{ "data/BGM/tut_bgm_in.wav",	1.0f, 0 },	// インゲームBGM
	{ "data/SE/tut_start.wav",		0.7f, 0 },	// スタート
...
CSound::CSound()
{
	...
	for (int cnt = 0; cnt < SOUND_LABEL_MAX; cnt++)
	{
		m_apSourceVoice[cnt] = nullptr;
		m_apDataAudio[cnt] = nullptr;
		m_aSizeAudio[cnt] = 0;
	}
}
...
// セグメント一時停止(ラベル指定)
//=============================================================================
void CSound::Pause(SOUND_LABEL label)
{
	XAUDIO2_VOICE_STATE xa2state;
...
// セグメント再開(ラベル指定)
//=============================================================================
void CSound::Restart(SOUND_LABEL label)
{
	XAUDIO2_VOICE_STATE xa2state;
