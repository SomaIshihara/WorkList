...
void CMotion::SetModel(CModel** ppModel, int nNumModel)
{
	...
	/*for (int cntInfo = 0; cntInfo < INFO_NUM; cntInfo++)
	{
		for (int cntKeyInfo = 0; cntKeyInfo < KEYINFO_NUM; cntKeyInfo++)
		{
			...
			{
				m_aInfo[cntInfo].m_aKeyInfo[cntKeyInfo].m_pKey[cntKey].m_fPosX = 0.0f;
				m_aInfo[cntInfo].m_aKeyInfo[cntKeyInfo].m_pKey[cntKey].m_fPosY = 0.0f;
				m_aInfo[cntInfo].m_aKeyInfo[cntKeyInfo].m_pKey[cntKey].m_fPosZ = 0.0f;
				m_aInfo[cntInfo].m_aKeyInfo[cntKeyInfo].m_pKey[cntKey].m_fRotX = 0.0f;
				m_aInfo[cntInfo].m_aKeyInfo[cntKeyInfo].m_pKey[cntKey].m_fRotY = 0.0f;
				m_aInfo[cntInfo].m_aKeyInfo[cntKeyInfo].m_pKey[cntKey].m_fRotZ = 0.0f;
			}
			m_aInfo[cntInfo].m_aKeyInfo[cntKeyInfo].m_nFrame = 0;
		}
		m_aInfo[cntInfo].m_bLoop = false;
